...
// The boolean is false, and the time is the zero value, if u is not a
// Version 7 UUID; other versions either carry no timestamp or lay it out
// differently, so decoding them would return a plausible but wrong time.
//
